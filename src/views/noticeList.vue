          ...
          <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
		    ...
		    label="发布日期">
		     <template slot-scope="scope">
                ...
                label="操作">
                <template slot-scope="scope">
                                <el-button v-if="isAuth('notice','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="shDialog(scope.row)">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                <el-button v-if="isAuth('notice','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="shDialog(scope.row)">{{ contents.tableBtnFont == 1?'详情':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('notice','查看') && contents.tableBtnIcon == 0" type="success" size="mini" @click="shDialog(scope.row)">{{ contents.tableBtnFont == 1?'详情':'' }}</el-button>
                </template>
            </el-table-column>
        </el-table>
      </div>
	...
	<el-dialog
	  ...
	  <el-form ref="form" :model="shForm" label-width="80px" :rules="rules">
		<el-form-item label="标题">
		  <el-input type="input"  v-model="shForm.title" readonly></el-input>
		</el-form-item>
		<el-form-item label="发布日期">
		  <el-input type="input"  v-model="shForm.releaseDate" readonly></el-input>
		</el-form-item>
	
		<el-form-item label="公告内容">
			<span v-html="shForm.content"></span>
		</el-form-item>
