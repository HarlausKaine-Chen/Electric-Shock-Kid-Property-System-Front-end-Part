<template>
  <div class="addEdit-block">
    ...
    >
          ...
          <el-form-item class="input" label="姓名" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="手机号码" prop="phone">
          <el-input v-model="ruleForm.phone" 
              placeholder="手机号码" clearable  :readonly="ro.phone"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="手机号码" prop="phone">
              <el-input v-model="ruleForm.phone" 
	  ...
	  <el-col :span="12">
	  <el-form-item class="select" v-if="userType=='领导'"  label="角色" prop="userType">
	            <el-select v-model="ruleForm.userType" placeholder="请选择角色">
	              <el-option
	                  v-for="(item,index) in userType1Options"
	                  v-bind:key="index"
	                  :label="item"
	                  :value="item">
	              </el-option>
			  ...
			  <el-form-item class="select" v-else-if="userType=='宿管'"  label="角色" prop="userType">
			            <el-select v-model="userType" placeholder="请选择角色">
			              <el-option
			                  v-for="(item,index) in userType2Options"
			                  v-bind:key="index"
			                  :label="item"
			                  :value="item">
			              </el-option>
