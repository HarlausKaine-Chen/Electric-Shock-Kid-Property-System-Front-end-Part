  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="宿舍编号" prop="hostelNo">
              <el-input v-model="ruleForm.hostelNo" 
                placeholder="宿舍编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍名称" prop="hostelName">
          <el-input v-model="ruleForm.hostelName" 
              placeholder="宿舍名称" clearable  :readonly="ro.hostelName"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍名称" prop="hostelName">
              <el-input v-model="ruleForm.hostelName" 
                placeholder="宿舍名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="床位数" prop="num">
          <el-input v-model="ruleForm.num" 
              placeholder="床位数" clearable  :readonly="ro.num"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="床位数" prop="num">
              <el-input v-model="ruleForm.num" 
		...
		<el-col :span="12">
			<el-form-item class="input"  label="床1" prop="c1n">
			  <el-input v-model="ruleForm.c1n" 
				  placeholder="床1" clearable  readonly></el-input>
			</el-form-item>
		</el-col>
		<el-col :span="12">
			<el-form-item class="input"  label="床2" prop="c2n">
			  <el-input v-model="ruleForm.c2n" 
				  placeholder="床2" clearable  readonly></el-input>
			</el-form-item>
		</el-col>
		<el-col :span="12">
			<el-form-item class="input"  label="床3" prop="c3n">
			  <el-input v-model="ruleForm.c3n" 
				  placeholder="床3" clearable  readonly></el-input>
			</el-form-item>
		</el-col>
		<el-col :span="12">
			<el-form-item class="input"  label="床4" prop="c4n">
			  <el-input v-model="ruleForm.c4n" 
				  placeholder="床4" clearable  readonly></el-input>
			</el-form-item>
		</el-col>
		<el-col :span="12">
			<el-form-item class="input"  label="床5" prop="c5n">
			  <el-input v-model="ruleForm.c5n" 
				  placeholder="床5" clearable  readonly></el-input>
			</el-form-item>
		</el-col>
		<el-col :span="12">
			<el-form-item class="input"  label="床6" prop="c6n">
			  <el-input v-model="ruleForm.c6n" 
				  placeholder="床6" clearable  readonly></el-input>
			</el-form-item>
		</el-col>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.hostelNo = true;
            continue;
	            	            ...
	            	            if(o=='hostelName'){
            this.ruleForm.hostelName = obj[o];
	    this.ro.hostelName = true;
            continue;
          }
	            	            if(o=='num'){
            this.ruleForm.num = obj[o];
	    this.ro.num = true;
            continue;
          }
	                    }
...
info(id) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `hostelInfo/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
