  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="标题" prop="title">
              <el-input v-model="ruleForm.title" 
                placeholder="标题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="发布日期" prop="releaseDate">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.releaseDate" label="发布日期" prop="releaseDate">
...
<el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="公告内容" prop="content">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.content" label="公告内容" prop="content">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.content = this.ruleForm.content.replace(reg,'../../../hostel/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
